...
btn2.addEventListener("click", function () {
  ...
  div.innerHTML = `
  <p id="para2" class="mt-5  font-bold">You have completed the ${title2} issue at 10:53:42 PM</p>
  `;
  historyContainer.appendChild(div);
  alert("Board Updated Successfully");
...
btn3.addEventListener("click", function () {
  ...
  div.innerHTML = `
  <p id="para3" class="mt-5  font-bold">You have completed the ${title3} issue at 10:54:50 PM</p>
  `;
  historyContainer.appendChild(div);
...
btn4.addEventListener("click", function () {
  ...
  div.innerHTML = `
  <p id ="para4" class="mt-5  font-bold">You have completed the ${title4} issue at 10:51:40 PM</p>
...
btn5.addEventListener("click", function () {
  ...
  div.innerHTML = `
  <p id= "para5" class="mt-5  font-bold">You have completed the ${title5} issue at  10:51:43 PM</p>
  `;
  historyContainer.appendChild(div);
...
btn6.addEventListener("click", function () {
  ...
  div.innerHTML = `
  <p id="para6" class="mt-5  font-bold">You have completed the ${title6} issue at 10:54:40 PM</p>
  `;
  historyContainer.appendChild(div);
